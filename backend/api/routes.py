...
from backend.api.tuner import router as tuner_router
...
router.include_router(qna_router, prefix="/qna", tags=["qna"])
router.include_router(tuner_router, prefix="/tuner", tags=["tuner"])
