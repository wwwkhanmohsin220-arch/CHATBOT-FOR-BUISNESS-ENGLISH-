...
export function StatCard({ icon: Icon, title, value, unit, iconColorClass }: StatCardProps) {
  return (
    <div className="bg-[#131318] border border-[#454653] rounded-lg p-[20px] flex flex-col gap-2 group hover:border-[#818cf8] transition-colors relative overflow-hidden">
      ...
      {/* Value */}
      <div className="text-[20px] md:text-[48px] leading-[28px] md:leading-[56px] font-bold tracking-[-0.02em] text-[#e4e1e9] flex items-baseline gap-1">
        {value}
        {unit && (
